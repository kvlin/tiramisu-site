...
The application is **containerised using Docker** and deployed to **AWS ECS**, with automated **CI/CD via GitHub Actions**.
...
- Improve performance and mobile optimisation
